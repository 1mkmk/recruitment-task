...
Start-Process PowerShell -ArgumentList "-NoProfile -ExecutionPolicy Bypass -Command `"Set-Location '$PSScriptRoot\frontend-react'; yarn dev > $FrontendLogFile`"" -WindowStyle Hidden
