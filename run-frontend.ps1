...
Write-Host "Navigating to frontend2 directory..." -ForegroundColor Cyan
Set-Location -Path "$PSScriptRoot\frontend2"

# Check if the directory change was successful
if ((Get-Location).Path -notlike "*frontend2") {
    Write-Host "ERROR: Failed to navigate to frontend2 directory" -ForegroundColor Red
    exit 1
}
